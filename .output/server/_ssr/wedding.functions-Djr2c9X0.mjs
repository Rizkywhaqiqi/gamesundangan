...
//#region node_modules/.nitro/vite/services/ssr/assets/wedding.functions-Djr2c9X0.js
...
var submitRsvp = createServerFn({ method: "POST" }).inputValidator((raw) => rsvpSchema.parse(raw)).handler(submitRsvp_createServerFn_handler, async ({ data }) => {
...
var submitWish = createServerFn({ method: "POST" }).inputValidator((raw) => wishSchema.parse(raw)).handler(submitWish_createServerFn_handler, async ({ data }) => {
